  ...
  it("全 Presentation domain の cancellation behavior を snapshot 固定する", () => {
    ...
    expect(snapshot).toMatchInlineSnapshot(`
      [
        ...
        "volcano|volcanoAshfallScheduled|markCancelled|VolcanoVfvo53Aggregator",
        "volcano|volcanoAshfall|clearCurrent|VolcanoStateHolder,StandbyStateStore",
        ...
        "weatherWarningTimeseries|weatherWarningTimeseries|clearCurrent|",
