...
const PAGEABLE_KEYS = ["quake", "weather", "weatherWarningForecast", "briefing", "flood", "tornado", "volcano"] as const satisfies readonly PageableKey[];
...
export class CardPageCoordinator {
  ...
  private readonly periodMs: number;
  private readonly tickOverride: number | null;
  private runtime: Record<PageableKey, CardPageRuntime> = { quake: EMPTY_RUNTIME(), weather: EMPTY_RUNTIME(), weatherWarningForecast: EMPTY_RUNTIME(), briefing: EMPTY_RUNTIME(), flood: EMPTY_RUNTIME(), tornado: EMPTY_RUNTIME(), volcano: EMPTY_RUNTIME() };
  private substates: Record<PageableKey, CardPageSubstate> = { quake: EMPTY_SUBSTATE(), weather: EMPTY_SUBSTATE(), weatherWarningForecast: EMPTY_SUBSTATE(), briefing: EMPTY_SUBSTATE(), flood: EMPTY_SUBSTATE(), tornado: EMPTY_SUBSTATE(), volcano: EMPTY_SUBSTATE() };
  private labels: Record<PageableKey, string[]> = { quake: [], weather: [], weatherWarningForecast: [], briefing: [], flood: [], tornado: [], volcano: [] };
  private fingerprints: Record<PageableKey, string[]> = { quake: [], weather: [], weatherWarningForecast: [], briefing: [], flood: [], tornado: [], volcano: [] };
  private holdComplete: Record<PageableKey, ((identity: string) => void) | undefined> = {
    quake: undefined, weather: undefined, weatherWarningForecast: undefined, briefing: undefined, flood: undefined, tornado: undefined, volcano: undefined,
  };
  private timer: Timer | null = null;
  private epochHeld = false;
  ...
  diagnostics() {
    ...
    return {
      ...
      cards: {
        ...
        volcano: { ...this.cardDiagnostics("volcano"), ...this.substates.volcano, ...this.runtime.volcano },
      },
  ...
  dispose(): void {
    ...
    this.epochHeld = false;
    this.pendingAppearanceKeys.clear();
    this.runtime = { quake: EMPTY_RUNTIME(), weather: EMPTY_RUNTIME(), weatherWarningForecast: EMPTY_RUNTIME(), briefing: EMPTY_RUNTIME(), flood: EMPTY_RUNTIME(), tornado: EMPTY_RUNTIME(), volcano: EMPTY_RUNTIME() };
    this.substates = { quake: EMPTY_SUBSTATE(), weather: EMPTY_SUBSTATE(), weatherWarningForecast: EMPTY_SUBSTATE(), briefing: EMPTY_SUBSTATE(), flood: EMPTY_SUBSTATE(), tornado: EMPTY_SUBSTATE(), volcano: EMPTY_SUBSTATE() };
    this.labels = { quake: [], weather: [], weatherWarningForecast: [], briefing: [], flood: [], tornado: [], volcano: [] };
    this.fingerprints = { quake: [], weather: [], weatherWarningForecast: [], briefing: [], flood: [], tornado: [], volcano: [] };
    this.holdComplete = {
      quake: undefined, weather: undefined, weatherWarningForecast: undefined, briefing: undefined, flood: undefined, tornado: undefined, volcano: undefined,
    };
    this.notify();
