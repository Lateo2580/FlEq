...
260件=XML239+JSON21（2026-09-16 昇格: `promotion-2026-09-16.md`、新規3・既存5の来歴確定）。原本確認13（熊本8、WeatherCW VPWW56 1、dmdata 原本照合4: 福井VPWW55 11:40 既存＋20:04 新規、桜島VFVO52 発表・訂正 新規）・派生確認6（+3: EEW 2024-04-17 の77_01_01・77_01_26・36_01_10 は archive 原本の派生）・合成65（+1: 77_01_33 の取消は archive に無い合成）・未確認176（2026-09-12 の181＝取得元/hash不足156、Phase6B原本hashなし12、親原本不明コピー1、REST本文hashなし1、REST整形履歴なし4、checkpoint来歴不足6、Pi改変前hashなし1 から福井1・EEW4を来歴確定で除いた）。distributionは publicApproved 4（気象・火山4本、利用規約14項1号、2026-09-16 裁定 R8 P-3 A）／unconfirmed 256（EEW 4本は15項の確認待ち、他は個別根拠未確認）。公開mainへの配置承認は上記4本だけで、他は既存fixtureの所在台帳だ。 改変欄の再確認: 追記2行（Pi手順1・WeatherCW親hash1）、edited→unknownの降格4行（operational-v1/v2と各anonymized版）。4行は元からsourceStrength=unconfirmedのため強度別件数は不変、modification.kindはbyteIdentical13・edited7・synthetic65・unknown175（2026-09-16）。
仮分類再導出: 官署名あり182・synthetic命名46・官署名○○の洪水7・WeatherCW抽出断片1。「182/47/7」の47は合成46と断片1を混ぜるため区別。官署あり群のVPWP50人工8と不正日時1も合成へ移し、最終XMLは原本9・派生2・合成55・未確認170（2026-09-12）→ 原本13・派生5・合成56・未確認165（2026-09-16）。実在官署名では原本へ昇格しない。
